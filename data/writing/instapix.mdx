---
title: "Instapix, instagram web app concept"
publishedAt: '2021-08-09'
excerpt: 'Learn about the process that made Instapix come to life.'
media: ''
author: 'Shane Duncan'
tags: ['study-case']
---
...
<LiveLinks
  liveDemoURL="https://instapix-main.vercel.app/"
  sourceCodeURL="https://github.com/dshane1903/instapix-main"
/>

Learn about the process that made Instapix come to life as a web version of the famous instagram by Facebook.
...
In the span of about **6 weeks**, `Instapix` came together as a social media web platform that mimicks one of the most popular social media platforms out there, [Instagram](https://www.instagram.com/). Being a lover of experimental projects, I wanted to try out some technologies that I was unfamiliar with at the time. 

> **Note:** The project isn't meant to be used out in the wild nor is ment as an alternative to other products.

## The problem

The main problem relates more to me than the product itself, and that is adding more `skills` to my toolbox. Related to the product, at the time of making Instapix, Instagram lacked the possibility to post new photos/videos or stories from their web version.
...
<Image
  alt="Signup flow"
  src="/images/blog/instapix/sign-up.png"
  width={1355}
  height={623}
/>
...
<Image
  ...
  src="/images/blog/instapix/forgot-password.png"
  width={1355}
  height={623}
/>
...
<Image
  alt="Profile page"
  src="/images/blog/instapix/profile.png"
  width={1355}
  height={623}
/>
...
<Image
  ...
  src="/images/blog/instapix/restricted-profile.png"
  width={1355}
  height={623}
/>
...
Following the same concept as the **profile page** the post page is meant to be publicly shared with anyone, without the need of an account. But has the same restrictions as the profile page when it comes to interacting with the post.

<Image
  alt="Restricted post"
  src="/images/blog/instapix/restricted-post.png"
  width={1355}
  height={623}
/>
...
In app messaging capabilities are a must in any modern web application, therefore such a feature has been added to Instapix as well.
...
<Image
  alt="Inbox Page"
  src="/images/blog/instapix/inbox.png"
  width={1355}
  height={623}
/>
...
Another core feature of such an app is live notifications for in app actions. Instapix has a notification system that include the most common actions, including: `like, follow, chat add, chat delete, chat leave, direct message`.

A system for customizing what kind of notifications you recieve has been added as well.

<Image
  alt="Notifications Settings Page"
  src="/images/blog/instapix/notifications.png"
  width={1355}
  height={623}
/>
...
<Image
  alt="Settings page"
  src="/images/blog/instapix/settings.png"
  width={1355}
  height={623}
/>
...
<Image
  alt="Timeline page"
  src="/images/blog/instapix/timeline.png"
  width={1355}
  height={623}
/>
...
<Image
  alt="New Post page"
  src="/images/blog/instapix/new-post.png"
  width={1355}
  height={623}
/>
...
Explore posts page is a `discovery` page, allowing you to see suggested posts from other users you are not currently following (as opposed to the [timeline](/writing/instapix#timeline) which allows you to only see posts from people you are following).

<Image
  alt="Explore page"
  src="/images/blog/instapix/explore.png"
  width={1355}
  height={623}
/>
...
Searching feature allows you to find active accounts that are part of Instapix platform, it will show both accounts you follow and not currently following, that match your searching criteria.

<Image
  alt="Search page"
  src="/images/blog/instapix/search.png"
  width={1355}
  height={623}
/>
...
Throughout the development of the project, I had challenges from just finding the right approaches in documentations to full off implementation challanges of certain features.
...
Authentification with firebase has been a breeze. It works great with little effort from the developer, it integrates with their emailing feature, providing automatic emailling for sign-in up along with resetting passwords.

## MVP in the Wild

Through this experiment I was able to improve my skillset, and have a cool little project out in the wild. You can see a live demo of the project at [instapix.dshane.dev](https://instapix-main.vercel.app) as well as it's full source code on my github [dshane1903.github/instapix](https://github.com/dshane1903/instapix-main).